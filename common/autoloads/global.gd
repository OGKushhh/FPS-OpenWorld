...
@warning_ignore("unused_signal")
signal aim_mode_changed(aim_mode: bool)

@warning_ignore("unused_signal")
signal active_camera_fov_changed(fov: float)
...
@warning_ignore("unused_signal")
signal player_velocity_changed(velocity: Vector3)
...
@warning_ignore("unused_signal")
signal player_sprinting_changed(sprinting: bool)
